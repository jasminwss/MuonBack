...
"${PIXI_RUN[@]}" python /afs/cern.ch/work/j/jaweiss/private/MuonBack/Inspection/inspect_Back.py --tag TRY6LiSc_full_onlySIM --path /eos/user/j/jaweiss/MuonBack/TRY6LiSc/11921562
